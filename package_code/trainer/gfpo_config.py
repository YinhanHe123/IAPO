...
@dataclass
class GFPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`GFPOTrainer`].

    This class includes only the parameters that are specific to GFPO training. For a full list of training arguments,
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`GFPOTrainer`] is provided as a string.
        ...
        delta: (`float` or `None`, *optional*, defaults to `None`):
            Enables the upper clipping bound in two-sided GFPO loss when set to a float. If `None` (default), standard
            GFPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in
            the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
        epsilon_high (`float` or `None`, *optional*, defaults to `None`):
            Upper-bound epsilon value for clipping. If not specified, it defaults to the same value as the lower-bound
            specified in argument `epsilon`. Paper [GFPO](https://huggingface.co/papers/2503.14476) recommends `0.28`.
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. GFPO paper](https://huggingface.co/papers/2503.20783) recommends not scaling the rewards,
        ...
        loss_type (`str`, *optional*, defaults to `"bnpo"`):
            ...
            - `"gfpo"`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing number of active token in the local batch.
                ...
                `per_device_train_batch_size==1`, the loss is equivalent to the GFPO loss.
            - `"dr_gfpo"`: Aggregates token-level losses by normalizing with a global constant. This method was
                introduced in the [Dr. GFPO paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
                The value of the constant corresponds to `max_completion_length`.
        mask_truncated_completions (`bool`, *optional*, defaults to `False`):
            When enabled, truncated completions are excluded from the loss calculation, preventing them from being
            incorrectly penalized and introducing noise during training. According to the
            [GFPO](https://huggingface.co/papers/2503.14476) paper, this is a good practice for training stability.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger GFPO loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in GFPO we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "Enables the upper clipping bound in two-sided GFPO loss when set to a float. If `None` "
            "(default), standard GFPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This "
    ...
    epsilon_high: Optional[float] = field(
        ...
        metadata={
            ...
            "lower-bound specified in argument `epsilon`. Paper GFPO recommends `0.28`."
        },
    )
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. GFPO paper recommends not scaling the rewards, as scaling by the standard "
    ...
    loss_type: str = field(
        default="bnpo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are `gfpo`, `bnpo`, and `dr_gfpo`. "
            "`'gfpo'`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to "
            "length bias—this approach tends to prefer shorter completions with positive advantages and longer ones "
            "with negative advantages. "
            "`'bnpo'`: Aggregates token-level losses by normalizing number of active token in the local batch. "
            ...
            "`per_device_train_batch_size==1`, the loss is equivalent to the GFPO loss. "
            "`'dr_gfpo'`: Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. GFPO paper to eliminate length bias. The value of the constant corresponds to "
    ...
    mask_truncated_completions: bool = field(
        ...
        metadata={
            ...
            "being incorrectly penalized and introducing noise during training. According to the GFPO paper, this is "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger GFPO loss."},
    )
    ...
    top_num_gen: int = field(
        default=6,
        metadata={"help": "Number of generations to keep per prompt. If `1`, all generations are kept. If `>1`, the top "
            "`top_num_gen` generations are kept based on the entropy of the probability distribution at each sequence "
            "position."
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "GFPO requires at least 2 generations per prompt to calculate the advantages. You provided "
                f"{self.num_generations}, which is less than the minimum required."
            )

        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided GFPO loss yet.")
