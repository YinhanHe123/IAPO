...
@dataclass
class G2RPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`G2RPOTrainer`].

    This class includes only the parameters that are specific to G2RPO training. For a full list of training arguments,
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`G2RPOTrainer`] is provided as a string.
        ...
        delta: (`float` or `None`, *optional*, defaults to `None`):
            Enables the upper clipping bound in two-sided G2RPO loss when set to a float. If `None` (default), standard
            G2RPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in
            the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
        epsilon_high (`float` or `None`, *optional*, defaults to `None`):
            Upper-bound epsilon value for clipping. If not specified, it defaults to the same value as the lower-bound
            specified in argument `epsilon`. Paper [G2RPO](https://huggingface.co/papers/2503.14476) recommends `0.28`.
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. G2RPO paper](https://huggingface.co/papers/2503.20783) recommends not scaling the rewards,
        ...
        loss_type (`str`, *optional*, defaults to `"bnpo"`):
            ...
            - `"g2rpo"`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing number of active token in the local batch.
                ...
                `per_device_train_batch_size==1`, the loss is equivalent to the G2RPO loss.
            - `"dr_g2rpo"`: Aggregates token-level losses by normalizing with a global constant. This method was
                introduced in the [Dr. G2RPO paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
                The value of the constant corresponds to `max_completion_length`.
        mask_truncated_completions (`bool`, *optional*, defaults to `False`):
            When enabled, truncated completions are excluded from the loss calculation, preventing them from being
            incorrectly penalized and introducing noise during training. According to the
            [G2RPO](https://huggingface.co/papers/2503.14476) paper, this is a good practice for training stability.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger G2RPO loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in G2RPO we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "Enables the upper clipping bound in two-sided G2RPO loss when set to a float. If `None` "
            "(default), standard G2RPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This "
    ...
    epsilon_high: Optional[float] = field(
        ...
        metadata={
            ...
            "lower-bound specified in argument `epsilon`. Paper G2RPO recommends `0.28`."
        },
    )
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. G2RPO paper recommends not scaling the rewards, as scaling by the standard "
    ...
    loss_type: str = field(
        default="bnpo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are `g2rpo`, `bnpo`, and `dr_g2rpo`. "
            "`'g2rpo'`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to "
            "length bias—this approach tends to prefer shorter completions with positive advantages and longer ones "
            "with negative advantages. "
            "`'bnpo'`: Aggregates token-level losses by normalizing number of active token in the local batch. "
            ...
            "`per_device_train_batch_size==1`, the loss is equivalent to the G2RPO loss. "
            "`'dr_g2rpo'`: Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. G2RPO paper to eliminate length bias. The value of the constant corresponds to "
    ...
    mask_truncated_completions: bool = field(
        ...
        metadata={
            ...
            "being incorrectly penalized and introducing noise during training. According to the G2RPO paper, this is "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger G2RPO loss."},
    )
    ...
    model_name: str = field(
        default='/shared/public/models/Qwen/Qwen2.5-7B-Instruct',
        metadata={
            "help": "Model name for the entropy calculation.",
        },
    )
    data_name: str = field(
        default='MATH-500',
        metadata={
            "help": "Data name for the entropy calculation.",
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "G2RPO requires at least 2 generations per prompt to calculate the advantages. You provided "
                f"{self.num_generations}, which is less than the minimum required."
            )

        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided G2RPO loss yet.")
