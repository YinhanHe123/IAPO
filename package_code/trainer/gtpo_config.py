...
@dataclass
class GTPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`GTPOTrainer`].

    This class includes only the parameters that are specific to GTPO training. For a full list of training arguments,
    ...
    Parameters:
        ...
        delta: (`float` or `None`, *optional*, defaults to `None`):
            Enables the upper clipping bound in two-sided GTPO loss when set to a float. If `None` (default), standard
            GTPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in
            the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
        epsilon_high (`float` or `None`, *optional*, defaults to `None`):
            Upper-bound epsilon value for clipping. If not specified, it defaults to the same value as the lower-bound
            specified in argument `epsilon`. Paper [GTPO](https://huggingface.co/papers/2503.14476) recommends `0.28`.
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. GTPO paper](https://huggingface.co/papers/2503.20783) recommends not scaling the rewards,
        ...
        loss_type (`str`, *optional*, defaults to `"bnpo"`):
            ...
            - `"gtpo"`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing number of active token in the local batch.
                ...
                `per_device_train_batch_size==1`, the loss is equivalent to the GTPO loss.
            - `"dr_gtpo"`: Aggregates token-level losses by normalizing with a global constant. This method was
                introduced in the [Dr. GTPO paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
                The value of the constant corresponds to `max_completion_length`.
        mask_truncated_completions (`bool`, *optional*, defaults to `False`):
            When enabled, truncated completions are excluded from the loss calculation, preventing them from being
            incorrectly penalized and introducing noise during training. According to the
            [GTPO](https://huggingface.co/papers/2503.14476) paper, this is a good practice for training stability.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger GTPO loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in GTPO we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "Enables the upper clipping bound in two-sided GTPO loss when set to a float. If `None` "
            "(default), standard GTPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This "
    ...
    epsilon_high: Optional[float] = field(
        ...
        metadata={
            ...
            "lower-bound specified in argument `epsilon`. Paper GTPO recommends `0.28`."
        },
    )
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. GTPO paper recommends not scaling the rewards, as scaling by the standard "
    ...
    loss_type: str = field(
        default="bnpo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are `gtpo`, `bnpo`, and `dr_gtpo`. "
            "`'gtpo'`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to "
            "length bias—this approach tends to prefer shorter completions with positive advantages and longer ones "
            "with negative advantages. "
            "`'bnpo'`: Aggregates token-level losses by normalizing number of active token in the local batch. "
            ...
            "`per_device_train_batch_size==1`, the loss is equivalent to the GTPO loss. "
            "`'dr_gtpo'`: Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. GTPO paper to eliminate length bias. The value of the constant corresponds to "
    ...
    mask_truncated_completions: bool = field(
        ...
        metadata={
            ...
            "being incorrectly penalized and introducing noise during training. According to the GTPO paper, this is "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger GTPO loss."},
    )
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "GTPO requires at least 2 generations per prompt to calculate the advantages. You provided "
                f"{self.num_generations}, which is less than the minimum required."
            )

        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided GTPO loss yet.")
