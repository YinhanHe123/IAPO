...
_import_structure = {
    ...
    "gfpo_config": ["GFPOConfig"],
    "gfpo_trainer": ["GFPOTrainer"],
    "gtpo_config": ["GTPOConfig"],
    "gtpo_trainer": ["GTPOTrainer"],
    "s_grpo_lee_config": ["SGRPOLeeConfig"],
    "s_grpo_lee_trainer": ["SGRPOLeeTrainer"],
    "grpo_config": ["GRPOConfig"],
    "grpo_trainer": ["GRPOTrainer"],
    "g2rpo_critics_config": ["G2RPOCriticsConfig"],
    "g2rpo_critics_trainer": ["G2RPOCriticsTrainer"],
    "g2rpo_config": ["G2RPOConfig"],
    "g2rpo_trainer": ["G2RPOTrainer"],
...
if TYPE_CHECKING:
    ...
    from .g2rpo_trainer import G2RPOTrainer
    from .g2rpo_critic_config import G2RPOCriticsConfig
    from .g2rpo_critic_trainer import G2RPOCriticsTrainer
    from .gtpo_config import GTPOConfig
    from .gtpo_trainer import GTPOTrainer
    from .s_grpo_lee_config import SGRPOLeeConfig
    from .s_grpo_lee_trainer import SGRPOLeeTrainer
