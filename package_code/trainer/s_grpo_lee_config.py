...
@dataclass
class SGRPOLeeConfig(TrainingArguments):
    r"""
    Configuration class for the [`SGRPOLeeTrainer`].

    This class includes only the parameters that are specific to SGRPOLee training. For a full list of training arguments,
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`SGRPOLeeTrainer`] is provided as a string.
        ...
        delta (`float` or `None`, *optional*, defaults to `None`):
            Enables the upper clipping bound in two-sided SGRPOLee loss when set to a float. If `None` (default), standard
            SGRPOLee clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in
        ...
        scale_rewards (`str` or `bool`, *optional*, defaults to `"group"`):
            ...
            - `False` or `"none"`: no scaling is applied. The [Dr. SGRPOLee
        ...
        loss_type (`str`, *optional*, defaults to `"dapo"`):
            ...
            - `"dr_grpo"`: Aggregates token-level losses by normalizing with a global constant. This method was
              introduced in the [Dr. SGRPOLee paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing with the number of active token in the local
              ...
              `per_device_train_batch_size==1`, the loss is equivalent to the SGRPOLee loss.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger SGRPOLee loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in SGRPOLee we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "Enables the upper clipping bound in two-sided SGRPOLee loss when set to a float. If `None` "
            "(default), standard SGRPOLee clipping is used. Recommended to be greater than `1 + ε` when enabled. This "
    ...
    scale_rewards: str = field(
        ...
        metadata={
            ...
            "`'batch'`: rewards are scaled by the standard deviation across the entire batch, as recommended in the "
            "PPO Lite paper. "
            "`False` or `'none'`: no scaling is applied. The Dr. SGRPOLee paper recommends not scaling rewards, as "
    ...
    loss_type: str = field(
        ...
        metadata={
            ...
            "'dr_grpo': Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. SGRPOLee paper to eliminate length bias. The value of the constant corresponds to "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger SGRPOLee loss."},
    )
    ...
    alpha: float = field(
        default=350,
        metadata={
            "help": "Alpha parameter for the stochastic length mask. If `0.0`, no stochastic length mask is applied."
        },
    )
    k: int = field(
        default=700,
        metadata={
            "help": "K parameter for the stochastic length mask. If `0`, no stochastic length mask is applied."
        },
    )
    token_prob: float = field(
        default=0.0,
        metadata={
            "help": "Probability of the token being masked. If `0.0`, no token is masked."
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "SGRPOLee requires at least 2 generations per prompt to calculate the advantages. You provided "
                f"{self.num_generations}, which is less than the minimum required."
            )

        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided SGRPOLee loss yet.")
