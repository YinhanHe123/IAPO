...
@dataclass
class G2RPOCriticsConfig(TrainingArguments):
    r"""
    Configuration class for the [`G2RPOCriticsTrainer`].

    This class includes only the parameters that are specific to G2RPOCritics training. For a full list of training arguments,
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`G2RPOCriticsTrainer`] is provided as a string.
        ...
        delta: (`float` or `None`, *optional*, defaults to `None`):
            Enables the upper clipping bound in two-sided G2RPOCritics loss when set to a float. If `None` (default), standard
            G2RPOCritics clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in
            the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
        epsilon_high (`float` or `None`, *optional*, defaults to `None`):
            Upper-bound epsilon value for clipping. If not specified, it defaults to the same value as the lower-bound
            specified in argument `epsilon`. Paper [G2RPOCritics](https://huggingface.co/papers/2503.14476) recommends `0.28`.
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. G2RPOCritics paper](https://huggingface.co/papers/2503.20783) recommends not scaling the rewards,
        ...
        loss_type (`str`, *optional*, defaults to `"bnpo"`):
            ...
            - `"g2rpo_critics"`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing number of active token in the local batch.
                ...
                `per_device_train_batch_size==1`, the loss is equivalent to the G2RPOCritics loss.
            - `"dr_g2rpo_critics"`: Aggregates token-level losses by normalizing with a global constant. This method was
                introduced in the [Dr. G2RPOCritics paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
                The value of the constant corresponds to `max_completion_length`.
        mask_truncated_completions (`bool`, *optional*, defaults to `False`):
            When enabled, truncated completions are excluded from the loss calculation, preventing them from being
            incorrectly penalized and introducing noise during training. According to the
            [G2RPOCritics](https://huggingface.co/papers/2503.14476) paper, this is a good practice for training stability.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger G2RPOCritics loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in G2RPOCritics we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "Enables the upper clipping bound in two-sided G2RPOCritics loss when set to a float. If `None` "
            "(default), standard G2RPOCritics clipping is used. Recommended to be greater than `1 + ε` when enabled. This "
    ...
    epsilon_high: Optional[float] = field(
        ...
        metadata={
            ...
            "lower-bound specified in argument `epsilon`. Paper G2RPOCritics recommends `0.28`."
        },
    )
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. G2RPOCritics paper recommends not scaling the rewards, as scaling by the standard "
    ...
    loss_type: str = field(
        default="bnpo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are `g2rpo_critics`, `bnpo`, and `dr_g2rpo_critics`. "
            "`'g2rpo_critics'`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to "
            "length bias—this approach tends to prefer shorter completions with positive advantages and longer ones "
            "with negative advantages. "
            "`'bnpo'`: Aggregates token-level losses by normalizing number of active token in the local batch. "
            ...
            "`per_device_train_batch_size==1`, the loss is equivalent to the G2RPOCritics loss. "
            "`'dr_g2rpo_critics'`: Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. G2RPOCritics paper to eliminate length bias. The value of the constant corresponds to "
    ...
    mask_truncated_completions: bool = field(
        ...
        metadata={
            ...
            "being incorrectly penalized and introducing noise during training. According to the G2RPOCritics paper, this is "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger G2RPOCritics loss."},
    )
    ...
    surprise_weight: float = field(
        default=1.0,
        metadata={
            "help": "Weight for the surprise loss component. If `1.0` (default), the surprise loss is fully included."
        },
    )
    surprise_horizon: int = field(
        default=1,
        metadata={
            "help": "Horizon for the surprise bonus.",
        },
    )
    surprise_decay: float = field(
        default=0.5,
        metadata={
    ...
    confidence_weight: float = field(
        default=1.0,
        metadata={
            "help": "Weight for the confidence loss component. If `1.0` (default), the confidence loss is fully included."
        },
    )
    critics_path: Optional[str] = field(
        default="/shared/public/models/sentence-transformers/all-MiniLM-L6-v2",
        metadata={
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "G2RPOCritics requires at least 2 generations per prompt to calculate the advantages. You provided "
                f"{self.num_generations}, which is less than the minimum required."
            )

        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided G2RPOCritics loss yet.")
